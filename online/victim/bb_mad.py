...
class MAD(Blackbox):
    def __init__(self, epsilon=0.5, optim='linesearch', model_adv_proxy=None, max_grad_layer=None, ydist='l1',
                 oracle='extreme', disable_jacobian=False, objmax=True, out_path=None, log_prefix='', *args, **kwargs):
    ...
    def calc_distance(y, ytilde, ydist, device=torch.device('cuda')):
        ...
        ytilde = ytilde.to(torch.device('cuda'))
        if ydist == 'l1':
