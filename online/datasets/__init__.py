...
from online.datasets.cifarlike import CIFAR10, CIFAR100
from online.datasets.mnistlike import MNIST, KMNIST, EMNIST, EMNISTLetters, FashionMNIST
from online.datasets.ImageNette import ImageNette
